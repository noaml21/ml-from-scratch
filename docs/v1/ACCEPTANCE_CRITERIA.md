...
| A25 | README commands/environment/scope true; docs canonical and consistent; BUILD_STATE current and resumable; BUILD_LOG historical; V1_BUILD_REPORT has evidence, limitations and verified SHA | doc link/coverage review + final scoped diff |
